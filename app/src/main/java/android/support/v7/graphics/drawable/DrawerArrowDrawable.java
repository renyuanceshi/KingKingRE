...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * strokeWidth)) - (this.mBarGap * 2.0f))) / 4) * 2))) + (((double) strokeWidth) * 1.5d) + ((double) this.mBarGap)));
        if (this.mSpin) {
