...
public final class AppCompatDrawableManager {
    ...
    private android.graphics.drawable.Drawable loadDrawableFromDelegates(@android.support.annotation.NonNull android.content.Context r10, @android.support.annotation.DrawableRes int r11) {
        ...
        L_0x0041:
            ...
            if (r3 == 0) goto L_0x0088
            android.content.res.XmlResourceParser r3 = r0.getXml(r11)     // Catch:{ Exception -> 0x0080 }
            android.util.AttributeSet r6 = android.util.Xml.asAttributeSet(r3)     // Catch:{ Exception -> 0x0080 }
        L_0x006e:
            int r0 = r3.next()     // Catch:{ Exception -> 0x0080 }
            if (r0 == r8) goto L_0x0076
            if (r0 != r7) goto L_0x006e
        L_0x0076:
            if (r0 == r8) goto L_0x0093
            org.xmlpull.v1.XmlPullParserException r0 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ Exception -> 0x0080 }
            java.lang.String r2 = "No start tag found"
            r0.<init>(r2)     // Catch:{ Exception -> 0x0080 }
        ...
        L_0x0089:
            ...
            goto L_0x002e
        L_0x0093:
            java.lang.String r0 = r3.getName()     // Catch:{ Exception -> 0x0080 }
            android.support.v4.util.SparseArrayCompat<java.lang.String> r7 = r9.mKnownDrawableIdTags     // Catch:{ Exception -> 0x0080 }
            r7.append(r11, r0)     // Catch:{ Exception -> 0x0080 }
            android.support.v4.util.ArrayMap<java.lang.String, android.support.v7.widget.AppCompatDrawableManager$InflateDelegate> r7 = r9.mDelegates     // Catch:{ Exception -> 0x0080 }
            java.lang.Object r0 = r7.get(r0)     // Catch:{ Exception -> 0x0080 }
            android.support.v7.widget.AppCompatDrawableManager$InflateDelegate r0 = (android.support.v7.widget.AppCompatDrawableManager.InflateDelegate) r0     // Catch:{ Exception -> 0x0080 }
            if (r0 == 0) goto L_0x00ae
            android.content.res.Resources$Theme r7 = r10.getTheme()     // Catch:{ Exception -> 0x0080 }
            android.graphics.drawable.Drawable r1 = r0.createFromXmlInner(r10, r3, r6, r7)     // Catch:{ Exception -> 0x0080 }
        L_0x00ae:
            if (r1 == 0) goto L_0x0088
            int r0 = r2.changingConfigurations     // Catch:{ Exception -> 0x0080 }
            r1.setChangingConfigurations(r0)     // Catch:{ Exception -> 0x0080 }
            boolean r0 = r9.addDrawableToCache(r10, r4, r1)     // Catch:{ Exception -> 0x0080 }
