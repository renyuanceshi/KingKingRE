...
public class SwitchCompat extends CompoundButton {
    ...
    private boolean hitThumb(float f, float f2) {
        ...
        int i3 = (thumbOffset + this.mSwitchLeft) - this.mTouchSlop;
        return f > ((float) i3) && f < ((float) ((((i3 + this.mThumbWidth) + this.mTempRect.left) + this.mTempRect.right) + this.mTouchSlop)) && f2 > ((float) (i - i2)) && f2 < ((float) (this.mSwitchBottom + this.mTouchSlop));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTrackDrawable != null) {
            ...
            if (opticalBounds != null) {
                ...
                i2 = opticalBounds.top > rect.top ? (opticalBounds.top - rect.top) + i5 : i5;
                if (opticalBounds.right > rect.right) {
                    i6 -= opticalBounds.right - rect.right;
                }
                i3 = opticalBounds.bottom > rect.bottom ? i7 - (opticalBounds.bottom - rect.bottom) : i7;
            } else {
                i2 = i5;
                i3 = i7;
            }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (layout != null) {
            ...
            canvas.translate((float) ((width / 2) - (layout.getWidth() / 2)), (float) ((((i + i3) + (i2 - i4)) / 2) - (layout.getHeight() / 2)));
            layout.draw(canvas);
        }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            i8 = ((this.mSwitchWidth + paddingLeft) - i5) - i6;
            i7 = paddingLeft;
        } else {
            int width = (getWidth() - getPaddingRight()) - i6;
            i7 = i5 + (width - this.mSwitchWidth) + i6;
            i8 = width;
        }
        switch (getGravity() & 112) {
            case 16:
                i9 = (((getPaddingTop() + getHeight()) - getPaddingBottom()) / 2) - (this.mSwitchHeight / 2);
                height = this.mSwitchHeight + i9;
                break;
            case 80:
                height = getHeight() - getPaddingBottom();
                i9 = height - this.mSwitchHeight;
                break;
            default:
                i9 = getPaddingTop();
                height = this.mSwitchHeight + i9;
