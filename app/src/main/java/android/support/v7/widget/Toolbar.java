...
public class Toolbar extends ViewGroup {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mLogoView)) {
            ...
            i7 = max2;
            i8 = layoutChildRight(this.mLogoView, min2, iArr, min);
        } else {
            i7 = layoutChildLeft(this.mLogoView, max2, iArr, min);
            i8 = min2;
        }
        ...
        if (shouldLayout || shouldLayout2) {
            ...
            switch (this.mGravity & 112) {
                case 48:
                    i10 = this.mTitleMarginTop + layoutParams3.topMargin + getPaddingTop();
                    break;
                case 80:
            ...
            if (z2) {
                ...
                if (shouldLayout) {
                    ...
                    this.mTitleTextView.layout(measuredWidth, i10, i8, measuredHeight);
                ...
                if (shouldLayout2) {
                    ...
                    int i20 = i10 + layoutParams5.topMargin;
                    this.mSubtitleTextView.layout(i8 - this.mSubtitleTextView.getMeasuredWidth(), i20, i8, this.mSubtitleTextView.getMeasuredHeight() + i20);
                    int i21 = layoutParams5.bottomMargin;
                    i14 = i8 - this.mTitleMarginEnd;
                } else {
                    i14 = i8;
                }
                if (z3) {
                ...
                int i22 = (z3 ? this.mTitleMarginStart : 0) - iArr[0];
                i7 += Math.max(0, i22);
                ...
                if (shouldLayout) {
                    ...
                    this.mTitleTextView.layout(i7, i10, measuredWidth2, measuredHeight2);
                    i11 = measuredWidth2 + this.mTitleMarginEnd;
                    i10 = ((LayoutParams) this.mTitleTextView.getLayoutParams()).bottomMargin + measuredHeight2;
                } else {
                    i11 = i7;
                }
                if (shouldLayout2) {
                    LayoutParams layoutParams6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                    int i23 = i10 + layoutParams6.topMargin;
                    int measuredWidth3 = this.mSubtitleTextView.getMeasuredWidth() + i7;
                    this.mSubtitleTextView.layout(i7, i23, measuredWidth3, this.mSubtitleTextView.getMeasuredHeight() + i23);
        ...
        for (int i27 = 0; i27 < size2; i27++) {
            i8 = layoutChildRight(this.mTempViews.get(i27), i8, iArr, min);
        }
        addCustomViewsWithGravity(this.mTempViews, 1);
        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
        int i28 = ((((width - paddingLeft) - paddingRight) / 2) + paddingLeft) - (viewListMeasuredWidth / 2);
        ...
        for (int i31 = 0; i31 < size3; i31++) {
            i30 = layoutChildLeft(this.mTempViews.get(i31), i30, iArr, min);
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (i9 < childCount) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType != 0) {
                ...
                i5 = Math.max(i4, childAt.getMeasuredHeight() + getVerticalMargins(childAt));
                i6 = ViewUtils.combineMeasuredStates(i10, ViewCompat.getMeasuredState(childAt));
            }
            i9++;
            i10 = i6;
            i4 = i5;
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            i10 = ViewUtils.combineMeasuredStates(i10, ViewCompat.getMeasuredState(this.mTitleTextView));
        }
        if (shouldLayout(this.mSubtitleTextView)) {
            ...
            i10 = ViewUtils.combineMeasuredStates(i10, ViewCompat.getMeasuredState(this.mSubtitleTextView));
        }
        int max4 = Math.max(i4, i12);
        int paddingLeft = getPaddingLeft();
        int paddingRight = getPaddingRight();
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        int resolveSizeAndState = ViewCompat.resolveSizeAndState(Math.max(i11 + max3 + paddingLeft + paddingRight, getSuggestedMinimumWidth()), i, -16777216 & i10);
        int resolveSizeAndState2 = ViewCompat.resolveSizeAndState(Math.max(max4 + paddingTop + paddingBottom, getSuggestedMinimumHeight()), i2, i10 << 16);
        if (shouldCollapse()) {
