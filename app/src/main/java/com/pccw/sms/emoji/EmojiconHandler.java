...
public final class EmojiconHandler {
    ...
    static {
        ...
        sEmojisMap.put(128113, R.drawable.emoji_1f471);
        ...
        sEmojisMap.put(128135, R.drawable.emoji_1f487);
        sEmojisMap.put(128133, R.drawable.emoji_1f485);
        sEmojisMap.put(128112, R.drawable.emoji_1f470);
        ...
        sEmojisMap.put(127793, R.drawable.emoji_1f331);
        sEmojisMap.put(127804, R.drawable.emoji_1f33c);
        sEmojisMap.put(127760, R.drawable.emoji_1f310);
        ...
        sEmojisMap.put(127889, R.drawable.emoji_1f391);
        ...
        sEmojisMap.put(127925, R.drawable.emoji_1f3b5);
        ...
        sEmojisMap.put(128693, R.drawable.emoji_1f6b5);
        sEmojisMap.put(128692, R.drawable.emoji_1f6b4);
        sEmojisMap.put(127937, R.drawable.emoji_1f3c1);
        sEmojisMap.put(127943, R.drawable.emoji_1f3c7);
        ...
        sEmojisMap.put(127940, R.drawable.emoji_1f3c4);
        ...
        sEmojisMap.put(127747, R.drawable.emoji_1f303);
        ...
        sEmojisMap.put(127905, R.drawable.emoji_1f3a1);
        ...
        sEmojisMap.put(128675, R.drawable.emoji_1f6a3);
        ...
        sEmojisMap.put(127915, R.drawable.emoji_1f3ab);
        ...
        sEmojisMap.put(127535, R.drawable.emoji_1f22f);
        sEmojisMap.put(127539, R.drawable.emoji_1f233);
        sEmojisMap.put(127541, R.drawable.emoji_1f235);
        ...
        sEmojisMap.put(127546, R.drawable.emoji_1f23a);
        sEmojisMap.put(127542, R.drawable.emoji_1f236);
        sEmojisMap.put(127514, R.drawable.emoji_1f21a);
        ...
        sEmojisMap.put(127543, R.drawable.emoji_1f237);
        ...
        sEmojisMap.put(127380, R.drawable.emoji_1f194);
        ...
        sEmojisMap.put(128243, R.drawable.emoji_1f4f3);
        sEmojisMap.put(128244, R.drawable.emoji_1f4f4);
        sEmojisMap.put(127344, R.drawable.emoji_1f170);
        sEmojisMap.put(127345, R.drawable.emoji_1f171);
        sEmojisMap.put(127374, R.drawable.emoji_1f18e);
        sEmojisMap.put(127358, R.drawable.emoji_1f17e);
        sEmojisMap.put(128160, R.drawable.emoji_1f4a0);
        ...
        sEmojisMap.put(128303, R.drawable.emoji_1f52f);
        sEmojisMap.put(127975, R.drawable.emoji_1f3e7);
    ...
    public static void addEmojis(Context context, Spannable spannable, int i) {
        ...
        for (EmojiIconSpan removeSpan : (EmojiIconSpan[]) spannable.getSpans(0, length, EmojiIconSpan.class)) {
        ...
        while (i5 < length) {
            ...
            if (codePointAt <= 255) {
                spannableStringBuilder.append(spannable.subSequence(i5, i5 + 1).toString());
            } else if (getEmojiResource(context, codePointAt) != 0 || charCount != 1) {
                spannableStringBuilder.append(spannable.subSequence(i5, i5 + charCount).toString());
            }
            i5 += charCount;
        }
        int i6 = 0;
        while (i6 < length) {
            ...
            if (i3 == 0) {
                ...
                int emojiResource = codePointAt2 > 255 ? getEmojiResource(context, codePointAt2) : i3;
                if (emojiResource != 0 || i6 + charCount2 >= length) {
                    i4 = charCount2;
                    i3 = emojiResource;
                } else {
                    int codePointAt3 = Character.codePointAt(spannable, i6 + charCount2);
                    if (codePointAt3 == 8419) {
                        int charCount3 = Character.charCount(codePointAt3);
                        switch (codePointAt2) {
                            case 35:
                                emojiResource = R.drawable.emoji_0023;
                                break;
                            case 48:
                                emojiResource = R.drawable.emoji_0030;
                                break;
                            case 49:
                                emojiResource = R.drawable.emoji_0031;
                                break;
                            case 50:
                                emojiResource = R.drawable.emoji_0032;
                                break;
                            case 51:
                                emojiResource = R.drawable.emoji_0033;
                                break;
                            case 52:
                                emojiResource = R.drawable.emoji_0034;
                                break;
                            case 53:
                                emojiResource = R.drawable.emoji_0035;
                                break;
                            case 54:
                                emojiResource = R.drawable.emoji_0036;
                                break;
                            case 55:
                                emojiResource = R.drawable.emoji_0037;
                                break;
                            case 56:
                                emojiResource = R.drawable.emoji_0038;
                                break;
                            case 57:
                                emojiResource = R.drawable.emoji_0039;
                                break;
                            default:
                                charCount3 = 0;
                                break;
                        }
                        i4 = charCount3 + charCount2;
                        i3 = emojiResource;
                    } else {
                        int charCount4 = Character.charCount(codePointAt3);
                        switch (codePointAt2) {
                            case 127464:
                                if (codePointAt3 != 127475) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1e8_1f1f3;
                                    break;
                                }
                            case 127465:
                                if (codePointAt3 != 127466) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1e9_1f1ea;
                                    break;
                                }
                            case 127466:
                                if (codePointAt3 != 127480) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1ea_1f1f8;
                                    break;
                                }
                            case 127467:
                                if (codePointAt3 != 127479) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1eb_1f1f7;
                                    break;
                                }
                            case 127468:
                                if (codePointAt3 != 127463) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1ec_1f1e7;
                                    break;
                                }
                            case 127470:
                                if (codePointAt3 != 127481) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1ee_1f1f9;
                                    break;
                                }
                            case 127471:
                                if (codePointAt3 != 127477) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1ef_1f1f5;
                                    break;
                                }
                            case 127472:
                                if (codePointAt3 != 127479) {
                                    ...
                                    emojiResource = R.drawable.emoji_1f1f0_1f1f7;
                                    break;
                                }
                            case 127479:
                                if (codePointAt3 != 127482) {
                                    emojiResource = 0;
                                    break;
                                } else {
                                    emojiResource = R.drawable.emoji_1f1f7_1f1fa;
                                    break;
                                }
                            case 127482:
                                if (codePointAt3 != 127480) {
                                    ...
                                    emojiResource = R.drawable.emoji_1f1fa_1f1f8;
                                    break;
                                }
                            default:
                                charCount4 = 0;
            ...
            if (i3 > 0) {
                spannable.setSpan(new EmojiIconSpan(context, i3, i), i6, i6 + i4, 33);
            }
            i6 += i4;
        }
    }
