...
import com.pccw.mobile.server.response.ImsiDNVerifyResponse;
import com.pccw.mobile.sip.ServerMessageController;
import org.xml.sax.Attributes;
import org.xml.sax.SAXException;

public class ImsiDNVerifyXmlHandler extends ApiXmlDefaultHandler {
    private ImsiDNVerifyResponse resp = new ImsiDNVerifyResponse();
