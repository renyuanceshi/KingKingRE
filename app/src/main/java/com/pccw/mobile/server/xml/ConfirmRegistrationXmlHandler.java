...
public class ConfirmRegistrationXmlHandler extends ApiXmlDefaultHandler {
    private ConfirmRegistrationResponse resp = new ConfirmRegistrationResponse();
    ...
    public void endElement(String str, String str2, String str3) throws SAXException {
        if (this.sb != null) {
            ...
            } else if ("activateFirstTime".equals(str2)) {
                this.resp.activateFirstTime = this.sb.toString().trim();
            }
            this.sb = null;
        }
    }
