...
class LoginLogger {
    ...
    public void logAuthorizationMethodNotTried(String str, String str2) {
        Bundle newAuthorizationLoggingBundle = newAuthorizationLoggingBundle(str);
        newAuthorizationLoggingBundle.putString(EVENT_PARAM_METHOD, str2);
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_METHOD_NOT_TRIED, (Double) null, newAuthorizationLoggingBundle);
    }
    ...
    public void logLoginStatusError(String str, Exception exc) {
        ...
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_STATUS_COMPLETE, (Double) null, newAuthorizationLoggingBundle);
    }
    ...
    public void logLoginStatusStart(String str) {
        this.appEventsLogger.logSdkEvent(EVENT_NAME_LOGIN_STATUS_START, (Double) null, newAuthorizationLoggingBundle(str));
    }
