...
public final class zzber<R extends Result> extends TransformedResult<R> implements ResultCallback<R> {
    ...
    public zzber(WeakReference<GoogleApiClient> weakReference) {
        ...
        this.zzaFf = new zzbet(this, googleApiClient != null ? googleApiClient.getLooper() : Looper.getMainLooper());
    }
    ...
    public final void onResult(R r) {
        synchronized (this.zzaBW) {
            if (!r.getStatus().isSuccess()) {
                ...
                zzbef.zzqj().submit(new zzbes(this, r));
            } else if (zzqL()) {
