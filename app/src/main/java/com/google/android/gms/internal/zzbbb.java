    ...
    public final void run() {
        if (this.zzaBS.mStarted) {
            ...
            if (zzpz.hasResolution()) {
                ...
                GoogleApiAvailability.zza(this.zzaBS.getActivity().getApplicationContext(), (zzbdk) new zzbbc(this, GoogleApiAvailability.zza(this.zzaBS.getActivity(), (DialogInterface.OnCancelListener) this.zzaBS)));
            } else {
