...
public abstract class zzbbd<R extends Result> extends PendingResult<R> {
    ...
    private final R get() {
        ...
        zzbew andSet = this.zzaCb.getAndSet((Object) null);
        if (andSet != null) {
            andSet.zzc(this);
        }
        return r;
    ...
    private final void zzb(R r) {
        ...
        if (this.zzJ) {
            ...
            this.zzaCc = new zzbbg(this, (zzbbe) null);
        }
    ...
    public final void setResultCallback(com.google.android.gms.common.api.ResultCallback<? super R> r6) {
        ...
        L_0x0011:
            ...
            com.google.android.gms.internal.zzber<R> r2 = r5.zzaCg     // Catch:{ all -> 0x0027 }
        ...
        L_0x002e:
            ...
            com.google.android.gms.internal.zzbbf<R> r0 = r5.zzaBX     // Catch:{ all -> 0x0027 }
    ...
    public final void setResultCallback(com.google.android.gms.common.api.ResultCallback<? super R> r7, long r8, java.util.concurrent.TimeUnit r10) {
        ...
        L_0x0011:
            java.lang.String r4 = "Result has already been consumed."
            com.google.android.gms.common.internal.zzbo.zza((boolean) r2, (java.lang.Object) r4)     // Catch:{ all -> 0x0027 }
            com.google.android.gms.internal.zzber<R> r2 = r6.zzaCg     // Catch:{ all -> 0x0027 }
            if (r2 != 0) goto L_0x002c
        L_0x001a:
            java.lang.String r1 = "Cannot set callbacks if then() has been called."
            com.google.android.gms.common.internal.zzbo.zza((boolean) r0, (java.lang.Object) r1)     // Catch:{ all -> 0x0027 }
        ...
        L_0x002e:
            ...
            if (r0 == 0) goto L_0x003f
            com.google.android.gms.internal.zzbbf<R> r0 = r6.zzaBX     // Catch:{ all -> 0x0027 }
