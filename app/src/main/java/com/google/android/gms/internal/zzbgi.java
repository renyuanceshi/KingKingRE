...
public final class zzbgi<I, O> extends zza {
    ...
    public zzbgj<I, O> zzaIQ;
    private final int zzaku;

    zzbgi(int i, int i2, boolean z, int i3, boolean z2, String str, int i4, String str2, zzbgb zzbgb) {
        this.zzaku = i;
        this.zzaIH = i2;
        this.zzaII = z;
        this.zzaIJ = i3;
        ...
        if (zzbgb == null) {
            ...
            this.zzaIQ = zzbgb.zzrK();
        }
    }

    private zzbgi(int i, boolean z, int i2, boolean z2, String str, int i3, Class<? extends zzbgh> cls, zzbgj<I, O> zzbgj) {
        this.zzaku = 1;
        this.zzaIH = i;
        this.zzaII = z;
        this.zzaIJ = i2;
    ...
    public static zzbgi zza(String str, int i, zzbgj<?, ?> zzbgj, boolean z) {
        return new zzbgi(7, false, 0, false, str, i, (Class<? extends zzbgh>) null, zzbgj);
    }

    public static <T extends zzbgh> zzbgi<T, T> zza(String str, int i, Class<T> cls) {
        return new zzbgi<>(11, false, 11, false, str, i, cls, (zzbgj) null);
    }

    public static <T extends zzbgh> zzbgi<ArrayList<T>, ArrayList<T>> zzb(String str, int i, Class<T> cls) {
        return new zzbgi<>(11, true, 11, true, str, i, cls, (zzbgj) null);
    }

    public static zzbgi<Integer, Integer> zzj(String str, int i) {
        return new zzbgi<>(0, false, 0, false, str, i, (Class<? extends zzbgh>) null, (zzbgj) null);
    }

    public static zzbgi<Boolean, Boolean> zzk(String str, int i) {
        return new zzbgi<>(6, false, 6, false, str, i, (Class<? extends zzbgh>) null, (zzbgj) null);
    }

    public static zzbgi<String, String> zzl(String str, int i) {
        return new zzbgi<>(7, false, 7, false, str, i, (Class<? extends zzbgh>) null, (zzbgj) null);
    }
    ...
    public final String toString() {
        ...
        Class<? extends zzbgh> cls = this.zzaIN;
        if (cls != null) {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzd.zza(parcel, 9, (Parcelable) this.zzaIQ == null ? null : zzbgb.zza(this.zzaIQ), i, false);
        zzd.zzI(parcel, zze);
    }

    public final void zza(zzbgn zzbgn) {
        this.zzaIP = zzbgn;
    }
