...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    protected static class CipherGen {
        ...
        public byte[] getLM2SessionResponse() throws NTLMEngineException {
            if (this.lm2SessionResponse == null) {
                ...
                Arrays.fill(this.lm2SessionResponse, clientChallenge3.length, this.lm2SessionResponse.length, (byte) 0);
            }
        ...
        public byte[] getTimestamp() {
            if (this.timestamp == null) {
                ...
                for (int i = 0; i < 8; i++) {
                    this.timestamp[i] = (byte) ((byte) ((int) currentTimeMillis));
                    currentTimeMillis >>>= 8;
                }
            }
    ...
    static class HMACMD5 {
        ...
        HMACMD5(byte[] bArr) throws NTLMEngineException {
            try {
                ...
                int i = 0;
                while (i < length) {
                    this.ipad[i] = (byte) ((byte) (bArr[i] ^ 54));
                    this.opad[i] = (byte) ((byte) (bArr[i] ^ 92));
                    i++;
                }
                for (int i2 = i; i2 < 64; i2++) {
                    this.ipad[i2] = (byte) 54;
                    this.opad[i2] = (byte) 92;
                }
                this.md5.reset();
    ...
    static class MD4 {
        ...
        public byte[] getOutput() {
            ...
            for (int i3 = 0; i3 < 8; i3++) {
                bArr[i2 + i3] = (byte) ((byte) ((int) ((this.count * 8) >>> (i3 * 8))));
            }
            update(bArr);
    ...
    static class NTLMMessage {
        ...
        public void addByte(byte b) {
            this.messageContents[this.currentOutputPosition] = (byte) b;
    ...
    static class Type1Message extends NTLMMessage {
        ...
        Type1Message(String str, String str2) throws NTLMEngineException {
            ...
            try {
                ...
                this.domainBytes = access$1500 != null ? access$1500.toUpperCase(Locale.US).getBytes("ASCII") : bArr;
    ...
    static class Type3Message extends NTLMMessage {
        ...
        Type3Message(String str, String str2, String str3, String str4, byte[] bArr, int i, String str5, byte[] bArr2) throws NTLMEngineException {
            ...
            if (access$1400 != null) {
                try {
                    bArr3 = access$1400.getBytes("UnicodeLittleUnmarked");
    ...
    public static Key createDESKey(byte[] bArr, int i) {
        ...
        byte[] bArr3 = {(byte) bArr2[0], (byte) ((byte) ((bArr2[0] << 7) | ((bArr2[1] & 255) >>> 1))), (byte) ((byte) ((bArr2[1] << 6) | ((bArr2[2] & 255) >>> 2))), (byte) ((byte) ((bArr2[2] << 5) | ((bArr2[3] & 255) >>> 3))), (byte) ((byte) ((bArr2[3] << 4) | ((bArr2[4] & 255) >>> 4))), (byte) ((byte) ((bArr2[4] << 3) | ((bArr2[5] & 255) >>> 5))), (byte) ((byte) ((bArr2[5] << 2) | ((bArr2[6] & 255) >>> 6))), (byte) ((byte) (bArr2[6] << 1))};
        oddParity(bArr3);
    ...
    static void writeULong(byte[] bArr, int i, int i2) {
        ...
        bArr[i2 + 1] = (byte) ((byte) ((i >> 8) & 255));
        bArr[i2 + 2] = (byte) ((byte) ((i >> 16) & 255));
        bArr[i2 + 3] = (byte) ((byte) ((i >> 24) & 255));
    }
