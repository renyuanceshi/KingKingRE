...
public class StrTokenizer implements ListIterator, Cloneable {
    ...
    private void checkTokenized() {
        ...
        if (this.chars == null) {
            List list = tokenize((char[]) null, 0, 0);
    ...
    public String toString() {
        return this.tokens == null ? "StrTokenizer[not tokenized yet]" : new StringBuffer().append("StrTokenizer").append(getTokenList()).toString();
    }
