...
public class MethodUtils {
    ...
    public static Method getMatchingAccessibleMethod(Class cls, String str, Class[] clsArr) {
        ...
        try {
            ...
            for (int i = 0; i < length; i++) {
                if (methods[i].getName().equals(str) && ClassUtils.isAssignable(clsArr, methods[i].getParameterTypes(), true) && (accessibleMethod = getAccessibleMethod(methods[i])) != null && (method2 == null || MemberUtils.compareParameterTypes(accessibleMethod.getParameterTypes(), method2.getParameterTypes(), clsArr) < 0)) {
    ...
    public static Object invokeExactMethod(Object obj, String str, Object[] objArr, Class[] clsArr) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        ...
        Method accessibleMethod = getAccessibleMethod((Class) obj.getClass(), str, clsArr);
