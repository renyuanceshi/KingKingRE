    ...
    class StrBuilderReader extends Reader {
        ...
        public int read(char[] cArr, int i, int i2) {
            if (i < 0 || i2 < 0 || i > cArr.length || i + i2 > cArr.length || i + i2 < 0) {
                ...
                int size = this.pos + i2 > this.this$0.size() ? this.this$0.size() - this.pos : i2;
                this.this$0.getChars(this.pos, this.pos + size, cArr, i);
                this.pos += size;
                return size;
            }
        }
        ...
        public long skip(long j) {
            long size = ((long) this.pos) + j > ((long) this.this$0.size()) ? (long) (this.this$0.size() - this.pos) : j;
            if (size < 0) {
                return 0;
            }
