...
public class ArrayUtils {
    ...
    public static int indexOf(long[] jArr, long j, int i) {
        ...
        for (int i2 = i < 0 ? 0 : i; i2 < jArr.length; i2++) {
            if (j == jArr[i2]) {
                return i2;
            }
        }
    ...
    public static int indexOf(boolean[] zArr, boolean z, int i) {
        ...
        for (int i2 = i < 0 ? 0 : i; i2 < zArr.length; i2++) {
            if (z == zArr[i2]) {
                return i2;
            }
        }
    ...
    static Object removeAll(Object obj, BitSet bitSet) {
        ...
        while (true) {
            ...
            int i4 = nextSetBit - i;
            if (i4 > 0) {
                System.arraycopy(obj, i, newInstance, i3, i4);
                i3 += i4;
            }
        ...
        int i5 = length - i;
        if (i5 > 0) {
            System.arraycopy(obj, i, newInstance, i3, i5);
        }
        return newInstance;
    }
        ...
        if (i < length) {
            ...
            while (length3 >= 0) {
                ...
                if (length - i5 > 1) {
                    int i6 = (length - i5) - 1;
                    i4 -= i6;
                    System.arraycopy(obj, i5 + 1, newInstance, i4, i6);
                }
                length3--;
                length = i5;
            }
